...
FirstRecall is a desktop [Obsidian](https://obsidian.md) plugin that turns notes into
...
you attempt each recall question before revealing the answer. FirstRecall saves generated
...
or **Entire vault**. Turn on automatic updates for the folders you want FirstRecall to keep
...
coverage. If an update fails, FirstRecall keeps the last successful material visible, marks it
...
FirstRecall requires Obsidian 1.11.4 or newer and is desktop-only. To install a development
