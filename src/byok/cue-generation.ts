/**
 * Cue-generation knobs shared by provider prompts and host-app settings.
 *
 * BYOK owns the prompt guidance because providers need it to produce the
 * package's cue and summary contracts. Host apps can surface these same option
 * lists in their own UI.
 */
