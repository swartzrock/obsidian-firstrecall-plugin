...
- **Model compatibility badges and warnings.** OpenRouter model metadata now powers restrained
  picker badges for recommended, structured-output-friendly, large-context, and low-cost models.
  CueCraft-suitable options sort above less-compatible choices without hiding them, and a
