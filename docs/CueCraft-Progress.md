...
_Last updated: 2026-06 (Study Area Autopilot shipped: parent-folder study areas, previewed backfill, retry/cancel/exclusion controls, and opt-in maintain-on-save. 348 unit tests passing; typecheck + production build green.)_
